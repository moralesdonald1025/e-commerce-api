...
const userData = auth.decode(req.headers.authorization)
	...
	userController.setAsAdmin(req.params.body.isAdmin, {userData: userData.id, isAdmin:userData.isAdmin}).then(resultFromController => res.send(resultFromController))
})
